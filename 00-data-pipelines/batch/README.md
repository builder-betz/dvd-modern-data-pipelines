...
The batch dashboard presents historical user behaviour and content performance trends, enabling consistent reporting and long-term, strategic analysis. Data comes from the one big table (OBT) serving layer of Databricks.
...
2. **Airbyte**: extracts data from a Postgres RDS source and performs a full load into Databricks Bronze tables.
3. **Dagster+**: orchestrates dbt Core transformations.
4. **DBT**: performs full-load transformations from Bronze → Silver.
5. **DBT**: performs full-load transformations from Silver → Gold, producing analytics-ready models.
6. **Preset dashboards**: query a the one-big-table generated by the batch pipeline for historical analysis.
...
![Demo Run](../../03-data-orchestration/batch/dagster/images/batch-gif-lineage-progress.gif)

</div>

---
🔗 **Page Navigation**:  [Main](../../README.md) | Batch | [Streaming](../streaming/README.md) | [Prev](../../README.md) | [Next](../../00-data-source/batch/README.md)
